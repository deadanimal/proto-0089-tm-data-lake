...
export class DevelopFlowsComponent implements OnInit, OnDestroy {
  ...
  getChart() {
    ...
    let chart = am4core.create("chartflow", am4charts.XYChart3D);
  ...
  getChart1() {
    ...
    let chart = am4core.create("chartflow1", am4charts.PieChart);
